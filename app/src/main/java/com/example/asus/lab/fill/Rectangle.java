...
import com.example.asus.lab.settings.DrawingTools;
...
public class Rectangle extends DrawingTools {
    private int x1;
    private int y1;
    private int x2;
    private int y2;
    private DrawLineBr painter;


    public Rectangle(Bitmap mainBitmap, Bitmap fakeBitmap) {
        super(mainBitmap, fakeBitmap);
       // painter = new DrawLineBr(mainBitmap, fakeBitmap);
    }
